...
#define AC_DISPLAY_FLAPPY_UPDATE_INTERVAL   30
#define AC_DISPLAY_FLAPPY_START_UPDATE_INTERVAL 30
#define AC_DISPLAY_START_UPDATE_INTERVAL 30
...
enum {
	...
	AC_DISPLAY_FLAPPY_START_UPDATE,
